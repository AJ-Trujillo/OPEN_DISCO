...
--
-- Host: 127.0.0.1    Database: bd_open
-- ------------------------------------------------------
...
INSERT INTO `clientes` VALUES (1,'juan','juanito1@gmail.com','96325','jr.dsfgh');
...
INSERT INTO `detalle_ventas` (`id_detalle`, `id_venta`, `id_producto`, `cantidad`, `precio_unitario`) VALUES (13,6,1,2,50.00),(14,6,2,1,100.00);
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `fk_cliente_ventas` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`) ON DELETE CASCADE,
...
INSERT INTO `ventas` VALUES (6,1,2,'2025-01-17 14:32:50',150.00,'tarjeta','completada','Primera venta registrada'),(7,1,2,'2025-01-17 14:45:53',200.00,'tarjeta','completada','Venta registrada para prueba'),(8,1,2,'2025-01-17 14:49:01',200.00,'tarjeta','completada','Venta de prueba para detalle_ventas');
/*!40000 ALTER TABLE `ventas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'bd_open'
--
/*!50003 DROP PROCEDURE IF EXISTS `actualizar_estado_usuario` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_estado_usuario`(
    IN p_id_usuario INT,
    IN p_estado INT
)
BEGIN
...
BEGIN
    SELECT id_usuario, nombre_usuario, correo, rol, fecha_registro, estado
    FROM usuarios
    WHERE id_usuario = p_id_usuario;
END ;;
DELIMITER ;
...
BEGIN
    ...
    FROM productos
    WHERE id_producto = p_id_producto
       OR nombre_producto LIKE CONCAT('%', p_nombre_producto, '%');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    VALUES (p_nombre_categoria, p_descripcion, p_estado);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    SELECT id_categoria, nombre_categoria, descripcion, estado, fecha_creacion, fecha_modificacion
    FROM categoria;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtenerNombresCategorias`(IN idCategoria INT)
BEGIN
